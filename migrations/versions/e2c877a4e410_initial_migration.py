...
def upgrade():
    ...
    sa.Column('role', sa.Enum('employee', 'store_user', 'admin', 'accountant', 'warehouseman', name='userrole'), nullable=False),
    ...
    sa.Column('finished_on', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('used_parts', sa.String(length=255), nullable=False),
    sa.Column('employ_comments', sa.String(length=255), nullable=False),
    sa.Column('state', sa.Enum('in_progress', 'done', 'cancelled', 'on_hold', name='taskstate'), nullable=False),
